...
<body>
    <div style="background-color:rgb(5, 37, 43); padding: 5%; font-family: 'Poppins', sans-serif;">
        <h1 style="color:rgb(6, 218, 255);  font-size: 24px;  text-align: center; font-family: 'Poppins', sans-serif;">Tooth Specialist</h1>
        <h2 style="color: white; font-size: 24px;  text-align: center; font-family: 'Poppins', sans-serif;padding: 5%;">
            Grazie per averci contattato <span style="color: rgb(6, 218, 255);">{{$contact['user']}}</span>
        </h2>
        <h2 style="color: white; font-size: 24px;  text-align: center; font-family: 'Poppins', sans-serif;padding: 5%;">
        ...
        <div style="display:flex; flex-wrap: wrap; justify-content: center; text-align: center;">
            <div style="color:rgb(6, 218, 255);">
                <p>© 2021 Studio Tooth Specialist.</p>
